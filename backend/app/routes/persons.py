...
persons_bp = Blueprint('persons', __name__, url_prefix='/api')
...
@persons_bp.route('/persons/tree', methods=['GET'])
def get_org_tree():
...
@persons_bp.route('/persons/<int:person_id>/subordinates', methods=['GET'])
